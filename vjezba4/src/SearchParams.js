...
const SearchParams = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedIgrackaType && selectedSubType) {
      try {
        const response = await fetch(`${MockDataService}vrstaIgracke/${selectedIgrackaType}/${selectedSubType}`);
        console.log(`${MockDataService}vrstaIgracke/${selectedIgrackaType}/${selectedSubType}`)
        const data = await response.json();
